  ...
  return (
    <>
      ...
      <section className="relative flex min-h-[92vh] items-end overflow-hidden">
        ...
        <div className="absolute inset-0">
          {heroImages.map((src, index) => (
            <img
              key={src}
              src={src}
              alt="Luxury modern Indian villa"
        ...
        {/* Hero content stays above the images */}
        <div className="relative z-10 mx-auto w-full max-w-[1200px] px-6 pb-20 pt-40 lg:px-10 lg:pb-28">
          <motion.p
            initial={{ opacity: 0, y: 14 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1] }}
            className="text-[10px] uppercase tracking-[0.32em] text-background/90 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]"
          >
          ...
          <motion.h1
            ...
            className="mt-6 max-w-3xl font-serif text-4xl leading-[1.1] text-background drop-shadow-[0_3px_5px_rgba(0,0,0,0.65)] sm:text-5xl lg:text-6xl"
          >
          ...
          <motion.p
            ...
            className="mt-6 max-w-xl text-base leading-relaxed text-background/90 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]"
          >
            Construction and interior design under one roof — from the first
            drawing to the last coat of plaster.
          </motion.p>

          {/* Working consultation button */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{
        ...
        <div className="grid gap-12 lg:grid-cols-12">
          ...
          <Reveal delay={0.1} className="lg:col-span-8">
            ...
            <p className="mt-8 max-w-2xl text-base leading-relaxed text-muted-foreground">
              Every project runs through one studio — design, structure,
              services and interiors — so decisions are made once and carried
              through to site without translation loss.
            </p>
          </Reveal>
        </div>
      </section>
                ...
                <article className="group">
                  ...
                  <ul className="mt-5 space-y-2">
                    {service.points.map((point) => (
                      ...
                      >
                        <span
                          className="mt-2 h-px w-4 shrink-0 bg-border"
                          aria-hidden="true"
                        />
                        {point}
                      </li>
      ...
      {/* <section className="mx-auto max-w-[1200px] px-6 py-24 lg:px-10 lg:py-32">
        <Reveal className="max-w-2xl">
          ...
          <p className="mt-6 text-base leading-relaxed text-muted-foreground">
            Architects, interior designers and site engineers who stay with
            your project from drawing to handover. Names and profiles are
        ...
        <div className="mt-16 grid gap-x-10 gap-y-12 sm:grid-cols-2 lg:grid-cols-4">
          {processSteps.map((step, i) => (
            <Reveal key={step.step} delay={i * 0.08}>
              <div className="border-t border-border pt-6">
                <span className="font-serif text-3xl text-accent-foreground/40">
                  {step.step}
                </span>
        ...
        <div className="mx-auto max-w-[1200px] px-6 text-center lg:px-10">
          <Reveal>
            ...
            <p className="mx-auto mt-6 max-w-lg text-base leading-relaxed text-background/75">
              A first conversation is a site visit, a brief and an honest view
              of what your budget can achieve in {site.city}.
            </p>
